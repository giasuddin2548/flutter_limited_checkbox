...
class FlutterSingleSelect extends StatefulWidget {
  ...
  @override
  _FlutterSingleSelectState createState() => _FlutterSingleSelectState();
}

class _FlutterSingleSelectState extends State<FlutterSingleSelect> {
  @override
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) => Row(
          ...
          children: [
                ...
                onChanged: (v){
                  setState(() {
                    if(widget.singleValueList[index].isSelected==false){
                      var checker=widget.singleValueList.where((element) => element.isSelected==true).toList().length;
                      var checkerIndex=widget.singleValueList.indexWhere((element) => element.isSelected==true);
                      if(checker<2){
                        if(checkerIndex!=-1){
            ...
            Text(widget.singleValueList[index].selectTitle, style: widget.titleTextStyle,)
          ],
        ),
